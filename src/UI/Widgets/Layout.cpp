...
// Constuctor - initializes the layout with default values and call the widget superclass constructor
Layout::Layout()
  : m_padding(0)
...
// based on the aligment and direction properties, this method lays out the widgets inside the layout
// e.g. if the alignment is set to {Alignment::Center, Alignment::Center} and the direction is set to Direction::Horizontal
// the widgets will be centered horizontally and vertically inside the layout (second widget to the right of the first one)
